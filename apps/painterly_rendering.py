...
def main(args):
    ...
    if args.use_blob:
        for i in range(num_paths):
            ...
            begin = torch.tensor([random.random()*canvas_width, random.random()*canvas_hight]),
            end = torch.tensor([random.random()*canvas_width, random.random()*canvas_hight]),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_gradients", dest='use_gradients', action='store_true')
